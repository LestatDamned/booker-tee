...
RU_LABELS = {
    ...
    "manual": "ручная",
    "member_disabled": "участник отключен",
    "member_reactivated": "участник восстановлен",
    "member_role_changed": "роль участника изменена",
    ...
    "workspace_invitation": "приглашение",
...
def current_context_processor(request: Request) -> dict[str, Any]:
    ...
    return {
        ...
        "current_membership": workspace_context.membership,
        "workspace_permissions": permission_flags_for(workspace_context.membership),
