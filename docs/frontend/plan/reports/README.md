...
Статус: active; Slice 01 completed, Slice 02 next.
...
| 2       | [`02_BREAKDOWNS.md`](02_BREAKDOWNS.md)                                   | next      | Анализирует категории и объекты без слияния сущностей         | 2–3 дня  |
| 3       | [`03_UNCATEGORIZED_OPERATIONS.md`](03_UNCATEGORIZED_OPERATIONS.md)       | planned   | Находит и просматривает bounded список операций без категории | 2–3 дня  |
