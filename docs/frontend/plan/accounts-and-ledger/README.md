...
Статус: active; Slices 01–04 completed.
...
| 4       | [`04_IMPORTED_OPERATION_CORRECTION.md`](04_IMPORTED_OPERATION_CORRECTION.md) | completed | Исправляет classification импортированной операции |  2–3 дня |
| 5       | [`05_CUTOVER_AND_CLEANUP.md`](05_CUTOVER_AND_CLEANUP.md)                     | planned   | Использует только React Accounts                    | 3–6 дней |

Imports child stage прошёл full Playwright audit и завершён. Accounts Slices
01–04 реализованы; следующий срез — Slice 05, общий cutover и cleanup.
