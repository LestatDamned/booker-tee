...
| [`02`](STAGE_02_VISUAL_FOUNDATION.md) | next | Tokens, themes and shared geometry are proven |
| [`03`](STAGE_03_MANUAL_LEDGER_READ.md) | planned | Manual ledger list works read-only through JSON API |
